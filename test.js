(function(qc) {
        ...
        gf: function(a) {
            ...
            switch (c) {
                ...
                case "colors":
                    ...
                    break;
                case "extrapolation":
                    2 == a.length ? (a = K.parseInt(a[1]), null != a ? (n.A.rd.Xa(a), this.ya.gm(a), this.ba("Extrapolation set to " + a + " msec")) : this.ba("Extrapolation must be a value between -200 and 50 milliseconds")) : this.ba("Extrapolation requires a value in milliseconds.");
                    break;
                case "handicap":
    ...
    Tb.prototype = {
        ...
        qj: function(a) {
            ...
            null == this.gh && (this.gh = window.setInterval(function() {
                b.update()
            }, 0), this.Um = window.performance.now())
        },
        connect: function(a) {
            this.Tg.connect(a)
        },
    ...
    N.prototype = {
        ...
        Ll: function(a, b) {
            this.c.beginPath();
            null == b ? (this.c.fillStyle = N.lc(a.R), this.c.strokeStyle = "white") : (this.c.fillStyle = b.Ij, this.c.strokeStyle = b.lo);
            this.c.beginPath();
    ...
    Qb.prototype = {
        tn: function(a) {
            0 > a ? (a = 150, this.c.fillStyle = "white") : this.c.fillStyle = "gray";
            var b = this.Vi,
                c = this.yk,
                d = this.Ah++;
            this.Ah >= b && (this.Ah = 0);
